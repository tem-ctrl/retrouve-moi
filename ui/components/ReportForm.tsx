...
const ReportForm: React.FC<ReportFormProps> = ({ onClose, onSuccess }) => {
  ...
  const isStep2Valid = data.last_seen_location && data.last_seen_date && data.region && data.description;
          ...
          {step === 1 && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Taille (en cm)</label>
                  <input
                    type="number"
                    name="height"
                    value={data.height}
                ...
                <div className="sm:col-span-2">
                  <label className="block text-sm font-medium text-gray-700 mb-1">Vêtements portés</label>
                  <textarea
          ...
          {step === 2 && (
            <div className="space-y-6">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-500 text-sm">Où et quand la personne a-t-elle été vue pour la dernière fois?</p>
              </div>

              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Dernière localisation connue *</label>
                  <input
                    type="text"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Date de disparition *</label>
                    <input
                      type="date"
                      name="last_seen_date"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Description des circonstances *</label>
                  <textarea
                    name="description"
                ...
                <div className="flex items-center gap-3 p-4 bg-red-50 rounded-xl">
                  ...
                  <label htmlFor="is_urgent" className="text-sm text-gray-700">
                    <span className="font-medium text-red-600">Cas urgent</span> - La personne est en danger immédiat
                  </label>
                </div>
              </div>
            </div>
          ...
          {step === 3 && (
            <div className="space-y-6">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-500 text-sm">Comment vous contacter si quelqu&apos;un a des informations?</p>
              </div>
