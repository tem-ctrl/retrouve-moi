    ...
    <section className="py-12 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-10">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Comment ça marche?</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Notre plateforme facilite le signalement et la recherche des personnes disparues en 4
            étapes simples
          </p>
        </div>
