      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white/70 text-sm leading-relaxed mb-4">
              Une plateforme citoyenne dédiée à la recherche des personnes disparues et des objets
              perdus au Cameroun.
            </p>
        ...
        <div className="border-t border-white/10 mt-8 pt-8">
          ...
          <p className="text-white/40 text-xs mt-4 text-center">
            En cas d&apos;urgence, contactez immédiatement les forces de l&apos;ordre locales. Cette
            plateforme est un service citoyen gratuit.
          </p>
        </div>
      </div>
    </footer>
