...
const Sidebar = React.forwardRef<HTMLDivElement, SidebarProps>(
  ({ className, size, collapsible, collapsed = false, children, ...props }, ref) => {
...
const SidebarHeader = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn('p-4 border-b border-border/40', className)} {...props} />
  ),
);
...
const SidebarFooter = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn('p-4 border-t border-border/40 mt-auto', className)} {...props} />
  ),
);
...
const SidebarSection = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => <div ref={ref} className={cn('mb-2', className)} {...props} />,
);
...
>(({ className, showIcon = false, ...props }, ref) => {
  // Random width between 50 to 90%. Generated in an effect (not during
  // render) since Math.random is an impure call React's purity rules
  // disallow in the render phase.
